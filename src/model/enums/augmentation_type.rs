...
use error::InvalidAugmentationType;
...
impl FromStr for AugmentationType {
    type Err = InvalidAugmentationType;
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            _ => Err(InvalidAugmentationType(s.into())),
        }
    }
}
...
pub mod error {
    ...
    #[error("InvalidAugmentationType: '{0}'")]
    pub struct InvalidAugmentationType(pub String);
}
